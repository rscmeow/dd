...
wget https://raw.githubusercontent.com/rscmeow/dd/master/redspaced -O /usr/local/bin/redspaced
wget https://raw.githubusercontent.com/rscmeow/dd/master/redspace-cli -O /usr/local/bin/redspace-cli
